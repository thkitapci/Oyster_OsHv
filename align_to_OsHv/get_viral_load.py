...
print "SampleName,All_Read_Counts,Mapped_Read_Count,Normalized_Viral_Count"
...
for file in glob.glob("/staging/sn1/tkitapci/Oyster_OsHv/alignments_to_OsHv/*-sorted-rmdupped.bam.stats"):
	...
	print "%s,%s,%s,%s"%(sampleName,all_read_count,mapped_read_count,normalized_viral_count)
